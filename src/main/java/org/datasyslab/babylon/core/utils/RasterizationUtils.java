 ...
 * PATH: org.datasyslab.babylon.core.utils.RasterizationUtils.java
...
public class RasterizationUtils implements Serializable{
	...
	public static int Encode2DTo1DId(int resolutionX, int resolutionY, int twoDimensionIdX,int twoDimensionIdY) throws Exception
	{
		...
		{
			throw new Exception("[RasterizationUtils][Encode2DTo1DId] This given 2 dimension coordinate is "+twoDimensionIdX+" "+twoDimensionIdY+". Resolution X and Y are "+resolutionX+" "+resolutionY+". This coordinate is out of the given boundary.");
		}
		/*
	 ...
	 * @return the list
	 */
	public static List<Tuple2<Pixel,Double>> FindOutlinePixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, Point spatialObject, SpatialAggregatorOption spatialAggregatorOption, boolean reverseSpatialCoordinate)
	{
		...
		if(spatialAggregatorOption == SpatialAggregatorOption.MIN || spatialAggregatorOption == SpatialAggregatorOption.MAX || spatialAggregatorOption == SpatialAggregatorOption.AVERAGE)
		{
	 ...
	 * @return the list
	 */
	public static List<Tuple2<Pixel,Double>> FindOutlinePixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, Polygon spatialObject,SpatialAggregatorOption spatialAggregatorOption, boolean reverseSpatialCoordinate)
	{
		List<Tuple2<Pixel,Double>> result = new ArrayList<Tuple2<Pixel,Double>>();
	 ...
	 * @return the list
	 */
	public static List<Tuple2<Pixel,Double>> FindOutlinePixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, LineString spatialObject,SpatialAggregatorOption spatialAggregatorOption, boolean reverseSpatialCoordinate)
	{	
		List<Tuple2<Pixel,Double>> result = new ArrayList<Tuple2<Pixel,Double>>();
		for(int i=0;i<spatialObject.getCoordinates().length-1;i++)
		{
	...
	{
		Tuple2<Integer,Integer> tileCoordinate = RasterizationUtils.Decode1DTo2DId(partitionsOnSingleAxis,partitionsOnSingleAxis,tileSerialId);
