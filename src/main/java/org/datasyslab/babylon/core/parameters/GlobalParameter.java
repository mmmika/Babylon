/**
 * FILE: GlobalParameter.java
 * PATH: org.datasyslab.babylon.core.parameters.GlobalParameter.java
...
import org.datasyslab.babylon.extension.photoFilter.PhotoFilterFactory;
...
public class GlobalParameter implements Serializable{
    ...
    public boolean set(String key, String value) {
        ...
        else if (key.equalsIgnoreCase("photoFilter")||key.equalsIgnoreCase("filter"))
        {
            this.photoFilter = PhotoFilterFactory.getPhotoFilter(value, this.filterRadius);
        }
